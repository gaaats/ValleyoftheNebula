...
import com.playgendary.sportmasterss.databinding.ActivityVebVieVieBinding
...
class VebVieVieActivity : AppCompatActivity() {
    ...
    lateinit var hrfghrdssxc: ActivityVebVieVieBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        hrfghrdssxc = ActivityVebVieVieBinding.inflate(layoutInflater)
...
// Setting External User Id with Callback Available in SDK Version 4.0.0+
    ...
    private fun urururururururur(): String {
        ...
        val pack = "com.playgendary.sportmasterss"

        val myTrID: String? = Hawk.get(GoodLikeManClass.myID, "null")
        val myInstId: String? = Hawk.get(GoodLikeManClass.instId, "null")
        val cpOne:String? = Hawk.get(C1, "null")
        val mainId: String? = Hawk.get(MAIN_ID, "null")

        val checkFly: String = Hawk.get(GoodLikeManClass.appsCheck, "null")
